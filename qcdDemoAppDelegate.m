...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // Create the Singleton Class - DataAccessObject - for view controllers to access
    
    self.sharedDAO = [DataAccessObject createSharedDataAccessObject];   // see: DataAccessObject.m
    
    // Set up the intial VC and launch it
    
    UIViewController *rootController = [[qcdDemoViewController alloc] initWithNibName:@"qcdDemoViewController" bundle:nil];
